...
root.iconbitmap(r'C:\Users\Admin\Documents\GitHub\PCube-PythonProgramsPyrizard\Python Programs\Temp\Simple File Opener\icons\favicon.ico')
...
photo1=PhotoImage(file=r'C:\Users\Admin\Documents\GitHub\PCube-PythonProgramsPyrizard\Python Programs\Temp\Simple File Opener\icons\music.png')
button1.config(image=photo1,width="170",height="120")
button1.pack(fill=X)

button2=Button(lbf,text="Images",justify = LEFT,command=openimages)
photo2=PhotoImage(file=r'C:\Users\Admin\Documents\GitHub\PCube-PythonProgramsPyrizard\Python Programs\Temp\Simple File Opener\icons\images.png')
button2.config(image=photo2,width="170",height="120")
button2.pack(fill=X)

button3=Button(lbf,text="Videos",justify = LEFT,command=openvideos)
photo3=PhotoImage(file=r'C:\Users\Admin\Documents\GitHub\PCube-PythonProgramsPyrizard\Python Programs\Temp\Simple File Opener\icons\videos.png')
button3.config(image=photo3,width="170",height="120")
button3.pack(fill=X)

button4=Button(lbf,text="Other Files",justify = LEFT,command=openothers)
photo4=PhotoImage(file=r'C:\Users\Admin\Documents\GitHub\PCube-PythonProgramsPyrizard\Python Programs\Temp\Simple File Opener\icons\others.png')
